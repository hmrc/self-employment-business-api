...
For versions 1.0 and later, Gov-Test-Scenario values that are not supported by the sandbox will result in a status code 400 response with an error code of INCORRECT_GOV_TEST_SCENARIO.
