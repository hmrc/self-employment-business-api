...
class RetrieveSelfEmploymentAnnualSummaryRequestParser @Inject()(val validator: RetrieveSelfEmploymentAnnualSummaryValidator)
  extends RequestParser[RetrieveSelfEmploymentAnnualSummaryRawData, RetrieveSelfEmploymentAnnualSummaryRequest] {

  override protected def requestFor(data: RetrieveSelfEmploymentAnnualSummaryRawData): RetrieveSelfEmploymentAnnualSummaryRequest =
    RetrieveSelfEmploymentAnnualSummaryRequest(Nino(data.nino), data.businessId, data.taxYear)
}