...
object PeriodDisallowableExpenses {
  ...
  implicit val reads: Reads[PeriodDisallowableExpenses] = (
  ...
  )(PeriodDisallowableExpenses.apply _)

  implicit val writes: OWrites[PeriodDisallowableExpenses] = Json.writes
}
