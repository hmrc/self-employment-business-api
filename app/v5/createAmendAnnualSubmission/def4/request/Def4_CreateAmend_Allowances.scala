...
case class Def4_CreateAmend_Allowances(annualInvestmentAllowance: Option[BigDecimal],
...
object Def4_CreateAmend_Allowances {
  implicit val reads: Reads[Def4_CreateAmend_Allowances] = Json.reads[Def4_CreateAmend_Allowances]

  implicit val writes: OWrites[Def4_CreateAmend_Allowances] = (
