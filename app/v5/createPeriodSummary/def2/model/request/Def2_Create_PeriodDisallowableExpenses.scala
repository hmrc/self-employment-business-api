...
import v5.createPeriodSummary.model.request.Create_PeriodDisallowableExpenses
...
object Def2_Create_PeriodDisallowableExpenses {
  ...
  implicit val writes: OWrites[Def2_Create_PeriodDisallowableExpenses] = (
  ...
  )(unlift(Def2_Create_PeriodDisallowableExpenses.unapply))
