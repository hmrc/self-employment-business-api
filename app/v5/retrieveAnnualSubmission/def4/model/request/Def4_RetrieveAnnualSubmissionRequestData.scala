...
case class Def4_RetrieveAnnualSubmissionRequestData(nino: Nino, businessId: BusinessId, taxYear: TaxYear)
    extends RetrieveAnnualSubmissionRequestData {
  override val schema: RetrieveAnnualSubmissionSchema = RetrieveAnnualSubmissionSchema.Def4
}
