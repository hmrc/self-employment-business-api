...
case class Def4_RetrieveAnnualSubmissionResponse(
...
object Def4_RetrieveAnnualSubmissionResponse {

  implicit val reads: Reads[Def4_RetrieveAnnualSubmissionResponse] = (
  ...
  )(Def4_RetrieveAnnualSubmissionResponse.apply)

  implicit val writes: OWrites[Def4_RetrieveAnnualSubmissionResponse] =
    Json.writes[Def4_RetrieveAnnualSubmissionResponse]
