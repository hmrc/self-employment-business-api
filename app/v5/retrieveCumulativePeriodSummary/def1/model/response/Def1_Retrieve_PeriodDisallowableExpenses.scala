...
object Def1_Retrieve_PeriodDisallowableExpenses {
  ...
  implicit val reads: Reads[Def1_Retrieve_PeriodDisallowableExpenses] = (
    (JsPath \ "costOfGoods" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "constructionIndustryScheme" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "staffCosts" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "travelCosts" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "premisesRunningCosts" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "maintenanceCosts" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "adminCosts" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "businessEntertainmentCosts" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "advertisingCosts" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "interest" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "financialCharges" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "badDebt" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "professionalFees" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "depreciation" \ "disallowableAmount").readNullable[BigDecimal] and
      (JsPath \ "other" \ "disallowableAmount").readNullable[BigDecimal]
  )(Def1_Retrieve_PeriodDisallowableExpenses.apply)
