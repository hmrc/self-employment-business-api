...
package v3.controllers.amendPeriodSummary.def2
...
import v3.controllers.amendPeriodSummary.model.request.{AmendPeriodSummaryRequestData, Def2_AmendPeriodSummaryRequestBody, Def2_AmendPeriodSummaryRequestData}
