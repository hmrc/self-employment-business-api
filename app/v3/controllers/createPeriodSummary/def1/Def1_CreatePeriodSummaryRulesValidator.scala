...
package v3.controllers.createPeriodSummary.def1
...
import v3.controllers.createPeriodSummary.def1.model.request.{
  Def1_Create_PeriodDisallowableExpenses,
  Def1_Create_PeriodExpenses,
  Def1_Create_PeriodIncome
}
import v3.controllers.createPeriodSummary.model.request.Def1_CreatePeriodSummaryRequestData
