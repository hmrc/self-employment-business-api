...
package v3.controllers.retrievePeriodSummary.model.response

import api.hateoas.{HateoasData, HateoasLinks, HateoasLinksFactory, Link}
import api.models.domain.{BusinessId, Nino, TaxYear}
import config.AppConfig
import play.api.libs.json.{JsPath, Json, OWrites, Reads}
import v3.controllers.retrievePeriodSummary.def1.model.response.{
  Def1_Retrieve_PeriodDates,
  Def1_Retrieve_PeriodDisallowableExpenses,
  Def1_Retrieve_PeriodExpenses,
  Def1_Retrieve_PeriodIncome
}
import v3.controllers.retrievePeriodSummary.def2.model.response.{
  Def2_Retrieve_PeriodDates,
  Def2_Retrieve_PeriodDisallowableExpenses,
  Def2_Retrieve_PeriodExpenses,
  Def2_Retrieve_PeriodIncome
}
import v3.controllers.retrievePeriodSummary.model.response.Def1_RetrievePeriodSummaryResponse.Def1_RetrieveAnnualSubmissionLinksFactory
import v3.controllers.retrievePeriodSummary.model.response.Def2_RetrievePeriodSummaryResponse.Def2_RetrieveAnnualSubmissionLinksFactory
