...
import v4.createPeriodSummary.model.request.Create_PeriodExpenses
...
object Def2_Create_PeriodExpenses {
  ...
  implicit val writes: OWrites[Def2_Create_PeriodExpenses] = (
  ...
  )(unlift(Def2_Create_PeriodExpenses.unapply))
