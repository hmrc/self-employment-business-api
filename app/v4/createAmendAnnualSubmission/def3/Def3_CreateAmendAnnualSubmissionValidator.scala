...
import v4.createAmendAnnualSubmission.def3.Def3_CreateAmendAnnualSubmissionRulesValidator.validateBusinessRules
import v4.createAmendAnnualSubmission.model.request.{CreateAmendAnnualSubmissionRequestData, Def3_CreateAmendAnnualSubmissionRequestData}

class Def3_CreateAmendAnnualSubmissionValidator(
    nino: String,
    businessId: String,
    taxYear: String,
    body: JsValue
  ...
  def validate: Validated[Seq[MtdError], CreateAmendAnnualSubmissionRequestData] =
    validateClass4ExemptionReasonEnum andThen { _ =>
      (
        ...
        resolveJson(body)
      ).mapN(Def3_CreateAmendAnnualSubmissionRequestData.apply) andThen validateBusinessRules
    }
