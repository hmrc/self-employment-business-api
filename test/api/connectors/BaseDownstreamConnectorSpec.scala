...
class BaseDownstreamConnectorSpec extends ConnectorSpec {
  ...
  class DesConnectTest extends MockHttpClient with MockAppConfig {
  ...
  class IfsConnectTest extends MockHttpClient with MockAppConfig {
  ...
  class TysIfsConnectTest extends MockHttpClient with MockAppConfig {
  ...
  "for DES" when {
    "post" must {
      "posts with the required headers and returns the result" in new DesConnectTest {
    ...
    "get" must {
      "get with the required headers and return the result" in new DesConnectTest {
        implicit val hc: HeaderCarrier = HeaderCarrier(otherHeaders = otherHeaders ++ Seq("Content-Type" -> "application/json"))
    ...
    "delete" must {
      "delete with the required headers and return the result" in new DesConnectTest {
        implicit val hc: HeaderCarrier = HeaderCarrier(otherHeaders = otherHeaders ++ Seq("Content-Type" -> "application/json"))
    ...
    "put" must {
      "put with the required headers and return result" in new DesConnectTest {
        implicit val hc: HeaderCarrier                   = HeaderCarrier(otherHeaders = otherHeaders ++ Seq("Content-Type" -> "application/json"))
    ...
    "content-type header already present and set to be passed through" must {
      "override (not duplicate) the value" when {
        ...
        def testNoDuplicatedContentType(userContentType: (String, String)): Unit =
          s"for user content type header $userContentType" in new DesConnectTest {
  ...
  "for IFS" when {
    "post" must {
      "posts with the required ifs headers and returns the result" in new IfsConnectTest {
        implicit val hc: HeaderCarrier                    = HeaderCarrier(otherHeaders = otherHeaders ++ Seq("Content-Type" -> "application/json"))
    ...
    "get" must {
      "get with the required headers and return the result" in new IfsConnectTest {
        implicit val hc: HeaderCarrier = HeaderCarrier(otherHeaders = otherHeaders ++ Seq("Content-Type" -> "application/json"))
    ...
    "delete" must {
      "delete with the required headers and return the result" in new IfsConnectTest {
        implicit val hc: HeaderCarrier = HeaderCarrier(otherHeaders = otherHeaders ++ Seq("Content-Type" -> "application/json"))
    ...
    "put" must {
      "put with the required headers and return result" in new IfsConnectTest {
        implicit val hc: HeaderCarrier                   = HeaderCarrier(otherHeaders = otherHeaders ++ Seq("Content-Type" -> "application/json"))
    ...
    "content-type header already present and set to be passed through" must {
      "override (not duplicate) the value" when {
        ...
        def testNoDuplicatedContentType(userContentType: (String, String)): Unit =
          s"for user content type header $userContentType" in new IfsConnectTest {
            implicit val hc: HeaderCarrier = HeaderCarrier(otherHeaders = otherHeaders ++ Seq(userContentType))
  ...
  "for TYS IFS" when {
    "post" must {
      "posts with the required tysIfs headers and returns the result" in new TysIfsConnectTest {
        implicit val hc: HeaderCarrier                       = HeaderCarrier(otherHeaders = otherHeaders ++ Seq("Content-Type" -> "application/json"))
    ...
    "get" must {
      "get with the required headers and return the result" in new TysIfsConnectTest {
        implicit val hc: HeaderCarrier = HeaderCarrier(otherHeaders = otherHeaders ++ Seq("Content-Type" -> "application/json"))
    ...
    "delete" must {
      "delete with the required headers and return the result" in new TysIfsConnectTest {
        implicit val hc: HeaderCarrier = HeaderCarrier(otherHeaders = otherHeaders ++ Seq("Content-Type" -> "application/json"))
    ...
    "put" must {
      "put with the required headers and return result" in new TysIfsConnectTest {
        implicit val hc: HeaderCarrier                      = HeaderCarrier(otherHeaders = otherHeaders ++ Seq("Content-Type" -> "application/json"))
    ...
    "content-type header already present and set to be passed through" must {
      "override (not duplicate) the value" when {
        ...
        def testNoDuplicatedContentType(userContentType: (String, String)): Unit =
          s"for user content type header $userContentType" in new TysIfsConnectTest {
            implicit val hc: HeaderCarrier = HeaderCarrier(otherHeaders = otherHeaders ++ Seq(userContentType))
