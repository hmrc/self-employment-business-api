...
trait Def2_CreateAmend_StructuredBuildingAllowanceFixture {

  val structuredBuildingAllowance: Def2_CreateAmend_StructuredBuildingAllowance =
    Def2_CreateAmend_StructuredBuildingAllowance(
      3000.30,
      Some(
        Def2_CreateAmend_FirstYear(
          "2020-01-01",
          3000.40
        )),
      Def2_CreateAmend_Building(
        Some("house name"),
        Some("house number"),
        "GF49JH"
      )
