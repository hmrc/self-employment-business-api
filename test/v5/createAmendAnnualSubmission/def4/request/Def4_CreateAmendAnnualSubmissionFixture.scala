...
trait Def4_CreateAmendAnnualSubmissionFixture extends Def4_CreateAmend_StructuredBuildingAllowanceFixture {

  val adjustments: Def4_CreateAmend_Adjustments =
    Def4_CreateAmend_Adjustments(
      ...
      adjustmentToProfitsForClass4 = Some(9.12)
    )
  ...
  val allowances: Def4_CreateAmend_Allowances = allowancesWith()
  ...
  val nonFinancials: Def4_CreateAmend_NonFinancials =
    Def4_CreateAmend_NonFinancials(businessDetailsChangedRecently = true, class4NicsExemptionReason = Some(MtdNicExemption.`non-resident`))
  ...
  def allowancesWith(structuredBuildingAllowances: Seq[Def4_CreateAmend_StructuredBuildingAllowance] = List(structuredBuildingAllowance),
                     enhancedStructuredBuildingAllowances: Seq[Def4_CreateAmend_StructuredBuildingAllowance] = List(structuredBuildingAllowance))
      : Def4_CreateAmend_Allowances =
    Def4_CreateAmend_Allowances(
  ...
  def createAmendAnnualSubmissionRequestBody(
      adjustmentsModel: Option[Def4_CreateAmend_Adjustments] = Some(adjustments),
      allowancesModel: Option[Def4_CreateAmend_Allowances] = Some(allowances),
      nonFinancialsModel: Option[Def4_CreateAmend_NonFinancials] = Some(nonFinancials)): Def4_CreateAmendAnnualSubmissionRequestBody =
    Def4_CreateAmendAnnualSubmissionRequestBody(adjustmentsModel, allowancesModel, nonFinancialsModel)
