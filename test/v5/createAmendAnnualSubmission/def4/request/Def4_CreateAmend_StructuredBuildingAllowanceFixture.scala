...
trait Def4_CreateAmend_StructuredBuildingAllowanceFixture {

  val structuredBuildingAllowance: Def4_CreateAmend_StructuredBuildingAllowance =
    Def4_CreateAmend_StructuredBuildingAllowance(
      3000.30,
      Some(
        Def4_CreateAmend_FirstYear(
          "2020-01-01",
          3000.40
        )),
      Def4_CreateAmend_Building(
        Some("house name"),
        Some("house number"),
        "GF49JH"
      )
