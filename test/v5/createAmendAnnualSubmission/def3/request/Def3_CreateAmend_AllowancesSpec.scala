...
class Def3_CreateAmend_AllowancesSpec extends UnitSpec {

  val model: Def3_CreateAmend_Allowances = Def3_CreateAmend_Allowances(
      ...
      "return the model" in {
        Json
          .parse(s"""{
             ...
             |}
             |""".stripMargin)
          .as[Def3_CreateAmend_Allowances] shouldBe model
      }
    }
  }
