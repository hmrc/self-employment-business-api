...
trait Def3_CreateAmendAnnualSubmissionFixture extends Def3_CreateAmend_StructuredBuildingAllowanceFixture {

  val adjustments: Def3_CreateAmend_Adjustments =
  ...
  val allowances: Def3_CreateAmend_Allowances = allowancesWith()
  val allowancesMtdJson: JsValue              = allowancesMtdJsonWith()
  val allowancesDownstreamJson: JsValue       = allowancesDownstreamJsonWith()

  val allowancesTradingIncomeAllowance: Def3_CreateAmend_Allowances = Def3_CreateAmend_Allowances(
    None,
    None,
    None,
    None,
  ...
  val nonFinancials: Def3_CreateAmend_NonFinancials =
    Def3_CreateAmend_NonFinancials(businessDetailsChangedRecently = true, class4NicsExemptionReason = Some(MtdNicExemption.`non-resident`))
  ...
  def allowancesWith(structuredBuildingAllowances: Seq[Def3_CreateAmend_StructuredBuildingAllowance] = List(structuredBuildingAllowance),
                     enhancedStructuredBuildingAllowances: Seq[Def3_CreateAmend_StructuredBuildingAllowance] = List(structuredBuildingAllowance))
      : Def3_CreateAmend_Allowances =
    Def3_CreateAmend_Allowances(
  ...
  def createAmendAnnualSubmissionRequestBody(
      adjustmentsModel: Option[Def3_CreateAmend_Adjustments] = Some(adjustments),
      allowancesModel: Option[Def3_CreateAmend_Allowances] = Some(allowances),
      nonFinancialsModel: Option[Def3_CreateAmend_NonFinancials] = Some(nonFinancials)): Def3_CreateAmendAnnualSubmissionRequestBody =
    Def3_CreateAmendAnnualSubmissionRequestBody(adjustmentsModel, allowancesModel, nonFinancialsModel)
