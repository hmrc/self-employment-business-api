...
class Def4_RetrieveAnnualSubmissionValidatorSpec extends UnitSpec {
  ...
  private def validator(nino: String, businessId: String, taxYear: String) =
    new Def4_RetrieveAnnualSubmissionValidator(nino, businessId, taxYear)
  ...
  "validator" should {
    "return the parsed domain object" when {
      "a valid request is made" in {
        ...
        result.shouldBe(Right(Def4_RetrieveAnnualSubmissionRequestData(parsedNino, parsedBusinessId, parsedTaxYear)))
      }
    }
