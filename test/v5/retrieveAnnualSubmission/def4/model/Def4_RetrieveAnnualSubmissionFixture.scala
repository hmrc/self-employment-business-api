...
package v5.retrieveAnnualSubmission.def4.model

import api.models.domain.ex.MtdNicExemption
import play.api.libs.json.{JsValue, Json}
import v5.retrieveAnnualSubmission.def4.model.response.*

trait Def4_RetrieveAnnualSubmissionFixture {
  ...
  val retrieveResponseModel: Def4_RetrieveAnnualSubmissionResponse = Def4_RetrieveAnnualSubmissionResponse(
    Some(adjustments),
    Some(allowances),
    Some(nonFinancials)
  )
