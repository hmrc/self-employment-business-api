...
trait MockCreateAmendCumulativePeriodSummaryService extends MockFactory {
  ...
  object MockedCreateAmendCumulativePeriodSummaryService {

    def createAmendCumulativePeriodSummary(requestData: CreateAmendCumulativePeriodSummaryRequestData): CallHandler[Future[ServiceOutcome[Unit]]] = {
      (
        mockAmendCumulativePeriodSummaryService
          .createAmendCumulativePeriodSummary(_: CreateAmendCumulativePeriodSummaryRequestData)(
            _: RequestContext,
            _: ExecutionContext
          )
        )
