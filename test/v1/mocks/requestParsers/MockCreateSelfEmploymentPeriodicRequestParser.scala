...
import v1.models.request.createSEPeriodic.{CreateSelfEmploymentPeriodicRawData, CreateSelfEmploymentPeriodicRequest}

trait MockCreateSelfEmploymentPeriodicRequestParser extends MockFactory {

  val mockCreateSelfEmploymentPeriodicRequestParser: CreateSelfEmploymentPeriodicRequestParser = mock[CreateSelfEmploymentPeriodicRequestParser]
