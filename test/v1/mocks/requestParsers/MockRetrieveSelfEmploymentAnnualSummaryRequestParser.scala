...
trait MockRetrieveSelfEmploymentAnnualSummaryRequestParser extends MockFactory {


  val mockRetrieveSelfEmploymentAnnualSummaryRequestParser:
    RetrieveSelfEmploymentAnnualSummaryRequestParser = mock[RetrieveSelfEmploymentAnnualSummaryRequestParser]
