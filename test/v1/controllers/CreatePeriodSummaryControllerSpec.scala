...
import v1.controllers.validators.MockCreatePeriodSummaryValidatorFactory
...
import v1.services.MockCreatePeriodSummaryService
...
class CreatePeriodSummaryControllerSpec
  ...
  private val periodId   = "2017-01-25_2018-01-25"
  ...
  private val requestBody =
    CreatePeriodSummaryBody(
      ...
      Some(PeriodIncome(Some(1000.99), Some(1000.99))),
      Some(
        PeriodAllowableExpenses(
      ...
      Some(
        PeriodDisallowableExpenses(
          ...
          Some(-99999999999.99), Some(-99999999999.99), Some(1000.99)
        ))
    )
  // @formatter:on
