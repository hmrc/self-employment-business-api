  ...
  "running a validation" should {
    ...
    "return a path parameter error" when {
      ...
      "a PeriodId containing an out of range date is supplied" in {
        validator.validate(amendPeriodSummary.AmendPeriodSummaryRawData(validNino, validBusinessId, "0010-01-01_2019-02-02", requestBodyJson, None)) shouldBe List(PeriodIdFormatError)
      }
    }
