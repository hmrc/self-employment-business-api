...
import v1.mocks.validators.MockCreateAmendSelfEmploymentAnnualSubmissionValidator
import v1.models.domain.Nino
import v1.models.errors._
import v1.models.domain.ex.MtdEx._
import v1.models.request.amendSEAnnual._
import v1.models.response.retrieveSEAnnual.Class4NicInfo
...
class AmendAnnualSummaryRequestParserSpec extends UnitSpec {
  ...
  trait Test extends MockCreateAmendSelfEmploymentAnnualSubmissionValidator {
    lazy val parser = new CreateAmendSelfEmploymentAnnualSubmissionRequestParser(mockValidator)
  }
