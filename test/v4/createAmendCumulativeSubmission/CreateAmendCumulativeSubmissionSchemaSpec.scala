...
class CreateAmendCumulativeSubmissionSchemaSpec extends UnitSpec {
  ...
  "schemaFor()" when {
    ...
    "given a minimum valid tax year" should {
      "return a Valid TaxYear" in {
        ...
        val result = CreateAmendCumulativeSubmissionSchema.schemaFor(validTaxYear)
    ...
    "given a tax year 2 years before the minimum " should {
      "return an Invalid with MtdError" in {
        ...
        val result = CreateAmendCumulativeSubmissionSchema.schemaFor(invalidTaxYear)
    ...
    "given a malformed tax year" should {
      "return an Invalid with TaxYearFormatError" in {
        ...
        val result = CreateAmendCumulativeSubmissionSchema.schemaFor(malformedTaxYear)
