...
package v4.createAmendCumulativeSubmission.def1.model.request

import play.api.libs.json.Json
import shared.utils.UnitSpec
import v4.createAmendCumulativeSubmission.model.request.Def1_CreateAmendCumulativeSubmissionRequestBody
import v4.createAmendCumulativeSubmission.model.request.Def1_CreateAmendCumulativeSubmissionRequestBody._

class CumulativeSubmissionBodySpec extends UnitSpec with CumulativeSubmissionFixture {

  val someOptionalFieldsMtdBody: Def1_CreateAmendCumulativeSubmissionRequestBody =
  ...
  val noOptionalFieldsMtdBody: Def1_CreateAmendCumulativeSubmissionRequestBody =
    Def1_CreateAmendCumulativeSubmissionRequestBody(PeriodDates("2025-08-24", "2026-08-24"), None, None, None)
  ...
  "reads" should {
    "read from a JSON" when {
      ...
      "a valid request with all optional fields is made" in {
        requestMtdBodyJson.as[Def1_CreateAmendCumulativeSubmissionRequestBody] shouldBe fullMTDRequest
      }

      "a valid request with some optional fields is made" in {
        someOptionalRequestJson.as[Def1_CreateAmendCumulativeSubmissionRequestBody] shouldBe someOptionalFieldsMtdBody
      }

      "a valid request with no optional fields is made" in {
        noOptionalRequestJson.as[Def1_CreateAmendCumulativeSubmissionRequestBody] shouldBe noOptionalFieldsMtdBody
      }
    }
  }
