...
trait CumulativeSubmissionFixture {
  ...
  val periodDisallowableExpenses: PeriodDisallowableExpenses = PeriodDisallowableExpenses(
  ...
  val fullMTDRequest: Def1_CreateAmendCumulativeSubmissionRequestBody = Def1_CreateAmendCumulativeSubmissionRequestBody(
