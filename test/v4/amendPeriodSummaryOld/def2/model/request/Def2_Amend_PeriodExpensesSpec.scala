...
class Def2_Amend_PeriodExpensesSpec extends UnitSpec {
  ...
  val model: Def2_Amend_PeriodExpenses = Def2_Amend_PeriodExpenses(
  ...
  "reads" should {
    "return a model" when {
      "passed a valid json" in {
        json.as[Def2_Amend_PeriodExpenses] shouldBe model
      }
    }
  }
