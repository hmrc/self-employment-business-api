...
class Def2_ListPeriodSummariesResponseSpec extends UnitSpec with MockSharedAppConfig {

  private val model = Def2_ListPeriodSummariesResponse(
    Seq(
      Def2_PeriodDetails(
  ...
  "reads" should {
    ...
    """.stripMargin
        ...
        .as[Def2_ListPeriodSummariesResponse[Def2_PeriodDetails]] shouldBe model
    }
  }
