...
trait MockRetrieveCumulativePeriodSummaryService extends TestSuite with MockFactory {
  ...
  object MockRetrieveCumulativePeriodSummaryService {

    def retrieve(
        requestData: RetrieveCumulativePeriodSummaryRequestData): CallHandler[Future[ServiceOutcome[RetrieveCumulativePeriodSummaryResponse]]] = {
      (
