...
class Def1_Create_PeriodDisallowableExpensesSpec extends UnitSpec {
  ...
  val model: Def1_Create_PeriodDisallowableExpenses = Def1_Create_PeriodDisallowableExpenses(
  ...
  "reads" should {
    "return a model" when {
      "passed a valid json" in {
        json.as[Def1_Create_PeriodDisallowableExpenses] shouldBe model
      }
    }
  }
