...
import v3.controllers.retrievePeriodSummary.def2.model.response.Def2_Retrieve_PeriodDates
import v3.controllers.retrievePeriodSummary.model.request.{Def1_RetrievePeriodSummaryRequestData, Def2_RetrievePeriodSummaryRequestData}
import v3.controllers.retrievePeriodSummary.model.response.{Def1_RetrievePeriodSummaryResponse, Def2_RetrievePeriodSummaryResponse, RetrievePeriodSummaryHateoasData, RetrievePeriodSummaryResponse}
