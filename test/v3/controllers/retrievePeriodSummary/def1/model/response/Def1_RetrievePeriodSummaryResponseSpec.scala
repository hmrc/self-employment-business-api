...
import v3.controllers.retrievePeriodSummary.def1.model.Def1_RetrievePeriodSummaryFixture
import v3.controllers.retrievePeriodSummary.model.response.{Def1_RetrievePeriodSummaryResponse, RetrievePeriodSummaryHateoasData}
