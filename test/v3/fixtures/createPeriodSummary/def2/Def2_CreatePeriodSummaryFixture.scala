...
package v3.fixtures.createPeriodSummary.def2

import play.api.libs.json.{JsValue, Json}
import v3.models.request.createPeriodSummary.def2._

trait Def2_CreatePeriodSummaryFixture {
  ...
  val periodDatesMtd: Def2_Create_PeriodDates = Def2_Create_PeriodDates(
    periodStartDate = "2019-08-24",
    periodEndDate = "2019-08-24"
  )

  val periodIncomeMtd: Def2_Create_PeriodIncome = Def2_Create_PeriodIncome(
    turnover = Some(1000.99),
    other = Some(2000.99),
    taxTakenOffTradingIncome = Some(3000.99)
  )

  val periodExpenses: Def2_Create_PeriodExpenses = Def2_Create_PeriodExpenses(
  ...
  val periodDisallowableExpenses: Def2_Create_PeriodDisallowableExpenses = Def2_Create_PeriodDisallowableExpenses(
  ...
  val fullMTDRequest: Def2_CreatePeriodSummaryRequestBody = Def2_CreatePeriodSummaryRequestBody(
