...
class RetrieveAnnualSubmissionControllerISpec extends IntegrationBaseSpec with Def1_RetrieveAnnualSubmissionFixture {
  ...
  "calling the V3 retrieve endpoint" should {
    ...
    "return a 200 status code" when {
        s"any valid request is made" in new NonTysTest {
          ...
          response.json shouldBe mtdRetrieveAnnualSubmissionJsonWithHateoas(nino, businessId, taxYear, mtdRetrieveResponseWithNoAdditionalFieldsJson)
