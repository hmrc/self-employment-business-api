...
class Def2_RetrievePeriodSummaryControllerIfsISpec extends IntegrationBaseSpec {

  override def servicesConfig: Map[String, Any] =
    Map("feature-switch.ifs_hip_migration_1786.enabled" -> false) ++ super.servicesConfig
