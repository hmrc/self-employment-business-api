...
class Def3_CreateAmendAnnualSubmissionControllerIfsISpec
  ...
  override def servicesConfig: Map[String, Any] =
    Map("feature-switch.ifs_hip_migration_1802.enabled" -> false) ++ super.servicesConfig
  ...
  private trait Test {
    ...
    def downstreamUri: String = s"/income-tax/25-26/$nino/self-employments/$businessId/annual-summaries"
