  ...
  "The V4 create endpoint" should {
    ...
    "downstream service error" when {
      ...
      val errors = List(
        ...
        (UNPROCESSABLE_ENTITY, "MISSING_SUBMISSION_DATES", BAD_REQUEST, RuleOneMissingPeriodSummaryDateError),
        (UNPROCESSABLE_ENTITY, "RULE_BOTH_MISSING_SUBMISSION_DATES", INTERNAL_SERVER_ERROR, RuleBothPeriodDatesMissingError),
